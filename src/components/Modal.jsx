        ...
        <div className="mx-auto w-10/12 d-flex justify-center items-center bg-white rounded-lg p-4 shadow-2xl">
          ...
          {cancelBtnText && submitBtnText && (
            <div className="flex justify-end gap-4 py-2">
              ...
              <button className="block  md:w-1/4  rounded-lg bg-rose-600 px-8 py-3 text-base font-bold text-white hover:bg-rose-500 focus:outline-none focus:ring active:bg-rose-500" onClick={handleSubmit}>
                {submitBtnText}
              </button>
            </div>
          )}
