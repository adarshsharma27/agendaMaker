...
const DashBoardTable = ({ users }) => {
  return (
    <>
      <div className="overflow-x-auto overflow-y-scroll h-[80vh] container my-6 mx-auto rounded-lg border border-gray-200  dark:bg-slate-700 card-shadow-custom shadow-xl">
